...
function Singlealbum(props) {
    ...
    return ( 
        ...
        <h5 class="mb-2 text-xl font-semibold tracking-tight text-gray-900 ">Album {props.name}</h5>
        {/* <h5 class="mb-2 text-xl font-semibold tracking-tight text-gray-900 ">test</h5> */}
        <p class="mb-3 font-normal text-gray-500 dark:text-gray-400">test</p>
        {showimg ? <button onClick={()=>{setshowimg(false)}} class="text-white bg-red-500 hover:bg-red-600  focus:ring-red-300  rounded-lg p-2 text-center ">hide images</button> :<button onClick={getImagesFromBacked} class="text-white bg-blue-500 hover:bg-blue-600  focus:ring-blue-300  rounded-lg p-2 text-center">View Images</button>}
        {showimg ? <div className="grid grid-cols-3 gap-4 mt-4"> {images.map((i)=>(
            ...
            <div className= "flex justify-center rounded-3xl ">
                <img className="p-8 rounded-t-lg aspect-[3/2] object-center object-none h-60 " src={i.source} />
            </div>
